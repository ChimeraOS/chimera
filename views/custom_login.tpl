...
<p class="platform-login-description">Please <a target="_blank" href="https://www.epicgames.com/id/api/redirect?clientId=34a02cf8f4414e29b15921876da36f9a&responseType=code">login to the Epic Games Store</a> and paste the authorization code that appears into the input box below.</p>
% elif platform == 'gog':
